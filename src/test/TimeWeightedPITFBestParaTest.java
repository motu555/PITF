 ...
 */
public class TimeWeightedPITFBestParaTest {
        ...
        for (int k = 0; k < initialTaoStep.length; k++) {
            ...
            for (int m = 0; m < baseStep.length; m++) {
                ...
                for (int i = 0; i < dstep.length; i++) {
                    ...
                    System.out.println("d " + d + " alphaUser " + alphaUser + " initialTao " + initialTao + " averageTrainTime " + TimePITF.getAverageTrainTime());
                }
            }
        }
