...
/**
 * Created by jinyuanyuan on 2018/4/3.
 */
public class TimeWeightedPITFTuningParaTest {
    ...
    public static void main(String[] args) throws IOException {
        String className = "TimeWeightedPITF";
            ...
            for (int k = 0; k < initialTaoStep.length; k++) {
                ...
                for (int m = 0; m < baseStep.length; m++) {
                    ...
                    for (int i = 0; i < dstep.length; i++) {
                        ...
                        TimeWeightedPITF TimePITF = new TimeWeightedPITF(trainPosts, testPosts, dim, initStdev, iter, learnRate, regU, regI, regT, randomSeed, numSample, d, base, initialTao, alphaUser, alpahItem);
                        TimePITF.run();

                        eachMeasureList = TimePITF.getMeasureList();
                        eachParas = new double[]{d, alphaUser, initialTao, base, TimePITF.getAverageTrainTime()};
                        ...
                        if (eachMeasureList.get(2).get(4) > maxF1) {//2表示是F1这个denseVector, 4表示是top5
                            ...
                            bestParas[3] = base;
                            bestParas[4] = TimePITF.getAverageTrainTime();
                        }
