...
public class Measures {
     ...
     *
     * @param <T>
     * @param rankedList a list of ranked item IDs, the highest-ranking item first
     ...
     */
    public static <T> Map<Integer, Double> PrecAt(List<T> rankedList, Set<T> groundTruth, List<Integer> ns) {
     ...
     */
    public static <T> double PrecAt(List<T> rankedList, Set<T> groundTruth, int n) {
     ...
     * different positions N
     */
    public static <T> Map<Integer, Double> RecallAt(List<T> rankedList, Set<T> groundTruth, List<Integer> ns) {
     ...
     */
    public static <T> Double RecallAt(List<T> rankedList, Set<T> groundTruth, int n) {
     ...
     */
    public static <T> int HitsAt(List<T> rankedList, Set<T> groundTruth, int n) {
        int hits = 0;
     ...
     * @param rankedList        a list of ranked item IDs, the highest-ranking item first
     * @param groundTruth       a collection of positive/correct item IDs
     * @param num_dropped_items the number of relevant items that were not ranked (considered
     ...
     * movies as bad.
     *
     * @param rate    real rating
     * @param pred    predicted rating
     * @param minRate mininmum rating scale
     * @param maxRate maximum rating scale
